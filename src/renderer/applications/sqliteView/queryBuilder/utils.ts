import type { SQLWithBindings, WhereConditionDescription } from "./types/query.type";
...
export function isWhereConditionDescription(condition: any): condition is WhereConditionDescription {
